<footer class="footer">
	...
	<div id="gotop2">
		<!--<i class="fa fa-angle-up">
			<div class="fb-messenger-icon"><a href="https://www.messenger.com/t/296361093707759/?messaging_source=source%3Apages%3Amessage_shortlink%3Futm_source%3Dktweb&amp;utm_medium=fbmesseger" target="new"><img src="<?php echo $cfg['Url'] ?>images/fb-messenger.png" class="img-fluid"></a></div>
		</i>
		<div class="top">
			<a href="###" target="_blank">
				<img src="images/icon/fb.svg" width="49" class="img-fluid" alt="">			
			</a>
		</div>-->
		<div class="top">
			<a href="https://www.kingtony.com/link/socialmedia/FBmesseger_tw_link.html?utm_source=KT-SideWeb-tw&utm_medium=FBmesseger_tw_link" target="_blank">
		...
		<div class="row">
			<div class="col-lg-3 col-sm-12">
				<div class="footer_box">
					<img src="<?php echo $cfg['Url'] ?>tw/images/footer_logo.svg" class="footer_logo img-fluid" alt="圖">
					<ul>
						<li>
						...
						<li>
							...
							<?php echo $System['SiteAddtw' . $cfg['Lang']]; ?>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="footer_box2">
					...
					<dl>
						...
						if ($Nums != 0) {
							...
							for ($j = 0; $j < 9; $j++) {
						?>
								<dd><a href="<?php echo $cfg['Url'] ?>tw/catalogs/<?php echo $Data[$j]['D_Seourltw']; ?>/?utm_source=KT-Web-Footer-tw&utm_medium=Pro-Cat-<?php echo $Data[$j]['D_Seourltw']; ?>"><?php echo $Data[$j]['D_Nametw']; ?></a></dd>
						<?php
							}
						}
						?>
			...
			<div class="col-lg-2 col-sm-3">
				<div class="footer_box2-2">
					<h4>關於我們</h4>
					<dl>
						<dd><a href="<?php echo $cfg['Url'] ?>tw/news.php?utm_source=KT-Web-Footer-tw&utm_medium=news">最新消息</a></dd>
						<dd><a href="<?php echo $cfg['Url'] ?>tw/about.php?utm_source=KT-Web-Footer-tw&utm_medium=about">品牌介紹</a></dd>
						<dd><a href="<?php echo $cfg['Url'] ?>tw/member.php?utm_source=KT-Web-Footer-tw&utm_medium=member">會員專區</a></dd>
						<dd><a href="<?php echo $cfg['Url'] ?>tw/support.php?utm_source=KT-Web-Footer-tw&utm_medium=support">技術支援</a></dd>
						<dd><a href="<?php echo $cfg['Url'] ?>tw/contact.php?utm_source=KT-Web-Footer-tw&utm_medium=contact">聯絡我們</a></dd>
						<dd><a href="<?php echo $cfg['Url'] ?>tw/hr.php?utm_source=KT-Web-Footer-tw&utm_medium=hr">工作機會</a></dd>
						<dd><a href="<?php echo $cfg['Url'] ?>tw/privacy.php?utm_source=KT-Web-Footer-tw&utm_medium=privacy">隱私政策</a></dd>
					</dl>
				</div>
			...
			<div class="col-lg-3 col-sm-12">
				<div class="footer_box3_top">
					<span>系統櫃App</span>
					<a href="https://www.kingtony.com/link/app/APP_iOS_link.html?utm_source=KT-Web-Footer-tw&utm_medium=APP_iOS"  target="_blank"><img src="<?php echo $cfg['Url'] ?>tw/images/ios.svg" class="img-fluid" alt="KT-App-iOS"></a>
					<a href="https://www.kingtony.com/link/app/APP_Android_link.html?utm_source=KT-Footer-tw&utm_medium=APP_Android"  target="_blank"><img src="<?php echo $cfg['Url'] ?>tw/images/andr.svg" class="img-fluid" alt="KT-App-Android"></a>
				</div>
				<div class="footer_box3_social">
					<ul>
						<li>關注我們</li>
						<li><a href="https://www.kingtony.com/link/socialmedia/FB_tw_link.html?utm_source=KT-Web-Footer-tw&utm_medium=FB_link" target="_blank">
						...
						<li><a href="https://www.kingtony.com/link/socialmedia/IG_link.html?utm_source=KT-Web-Footer-tw&utm_medium=IG_link" target="_blank">
						...
						<li><a href="https://www.kingtony.com/link/socialmedia/Linkedin_link.html?utm_source=KT-Web-Footer-tw&utm_medium=Linkedin_link" target="_blank">
								<svg xmlns="http://www.w3.org/2000/svg" width="24.526" height="24.526" viewBox="0 0 24.526 24.526">
						...
						<li><a href="https://www.kingtony.com/link/socialmedia/youtube_link.html?utm_source=KT-Web-Footer-tw&utm_medium=Youtube_link" target="_blank">
					...
					<p>
						...
						<a href="https://www.kingtony.com/link/taiwan/yungan_tw_link.html?utm_source=KT-Web-Footer-tw&utm_medium=yungan_web_tw" target="_blank">網站連結</a>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid footer_box4">
		<div class="row">
			<div class="col-sm-12">
				<p>Copyright © 2022 KING TONY All Rights Reserved.<a href="https://www.artware.com.tw/" title="艾傑網頁設計公司 網頁設計" target="_blank">Design by ARTWARE</a></p>
			</div>
		</div>
	</div>
